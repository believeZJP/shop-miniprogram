...
/*  作业要求：
  1.将项目在本地开发者工具正确的运行，能够闭环操作整个商品选购的全过程
  2.增加功能：点击购物车的商品信息，跳转至详情页
  3.增加功能：点击订单的商品信息，跳转至详情页
  4.增加功能：订单结算页时，直接拉起付款流程
  5.修复功能：购物车商品数量增加或减少时，合计价格不变的bug
  6.新增功能：结算页的配送地址选择用户的配送信息进行拉取展示
 */